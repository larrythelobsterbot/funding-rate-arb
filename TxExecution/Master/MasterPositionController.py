...
class MasterPositionController:
    ...
    def is_already_position_open(self) -> bool:
        try:
            ...
            is_gmx_position = False

            target_exchange_list = get_target_exchanges()

            try:
                if 'Binance' in target_exchange_list:
            ...
            try:
                if 'ByBit' in target_exchange_list:
            ...
            try:    
                if 'GMX' in target_exchange_list:
            ...
            if any(positions_open):
                logger.info(f"MasterPositionController - Position already open: Binance: {is_binance_position}, ByBit: {is_bybit_position}, GMX: {is_gmx_position}")
                return True
            else:
